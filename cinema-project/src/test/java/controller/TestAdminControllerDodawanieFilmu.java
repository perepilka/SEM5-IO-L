...
class TestAdminControllerDodawanieFilmu {
    ...
    void testDodajFilmWeryfikacja() {
        ...
        assertTrue(wynik.contains("F1"), "Wynik powinien zawierać wygenerowane ID");
        
        // Weryfikacja w DAO
        String zapisanyFilm = dao.znajdzFilm("F1");
    ...
    void testDodajWieleFilmow() {
        ...
        assertTrue(wynik1.contains("F1"), "Pierwszy film powinien mieć ID F1");
        assertTrue(wynik2.contains("F2"), "Drugi film powinien mieć ID F2");
        assertTrue(wynik3.contains("F3"), "Trzeci film powinien mieć ID F3");
        
        // Weryfikacja w DAO
        assertNotNull(dao.znajdzFilm("F1"));
        assertNotNull(dao.znajdzFilm("F2"));
        assertNotNull(dao.znajdzFilm("F3"));
    }
    ...
    void testPelnyPrzeplyw() {
        ...
        // (co wywołuje EdytowanieOfertyKina -> DodanieNowegoFilmu -> Model -> Fabryka -> DAO)
        String wynik = adminController.dodajFilm(daneFilmu);
