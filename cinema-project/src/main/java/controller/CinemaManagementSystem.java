...
public class CinemaManagementSystem {
	...
	public static void main(String[] args) {
		...
		String filmData1 = "F1;Incepcja;Thriller zaginający umysł;148;Sci-Fi;25.50";
		String result1 = adminController.dodajFilm(filmData1);
		System.out.println("Wynik: " + result1);

		String filmData2 = "F2;Matrix;Haker odkrywa rzeczywistość;136;Akcja;22.00";
		String result2 = adminController.dodajFilm(filmData2);
		System.out.println("Wynik: " + result2);

		String filmData3 = "F3;Titanic;Epicka romansowa katastrofa;194;Dramat;20.00";
